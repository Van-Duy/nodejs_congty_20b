...
const { findAll, findById, createUser, deleteUser, editUser, findUserByUsername, findOneItem } = require("../services/category.services")
...
module.exports = { updateCategory  , getAllCategory, addCategory, getCategoryById, removeCategory }