...
//     // const product = await findOneItem({ _id: idProduct })
//     // if (!product) throw new BAD_REQUEST_ERROR("Not found product")


//     // [
//     //     {userId : 1 , rating : 5 , productId : 10 },
//     //     {userId : 2 , rating : 5 , productId : 10},
//     //     {userId : 3 , rating : 4 , productId : 10},
//     // ]
//     // => kq

//     let isOk = await editUser(idProduct, {
//         rating: kq
//     });
